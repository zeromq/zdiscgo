...
IF %1.==--help. (
    ...
    ECHO    --without-zdiscgo_selftest  do not build zdiscgo_selftest.exe
    GOTO :eof
)
ECHO Configuring zdiscgo...
...
ECHO. >> platform.h
ECHO #define ZDISCGO_HAVE_WINDOWS 1>> platform.h
...
IF EXIST "..\..\..\libzmq" (
    ...
    ECHO zdiscgo cannot build without libzmq
...
IF EXIST "..\..\..\czmq" (
    ...
    ECHO zdiscgo cannot build without czmq
...
:with_draft
    ...
    ECHO #define ZDISCGO_BUILD_DRAFT_API 1>>platform.h
    GOTO end_draft
:no_draft
    ECHO Building without draft API (stable + legacy API)
    ECHO #undef ZDISCGO_BUILD_DRAFT_API 1>>platform.h
:end_draft
ECHO. >> platform.h
